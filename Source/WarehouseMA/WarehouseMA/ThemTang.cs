...
{
    public partial class ThemTang : Form
    {
        public ThemTang()
        {
            InitializeComponent();
        ...
        private void tieuDeThemTang_MouseDown(object sender, MouseEventArgs e)
        {
            dangKeo = true;
            diemBatDau = new Point(e.X, e.Y);
        }

        private void tieuDeThemTang_MouseMove(object sender, MouseEventArgs e)
        {
            if (dangKeo)
            {
        ...
        private void tieuDeThemTang_MouseUp(object sender, MouseEventArgs e)
        {
            dangKeo = false;
        }
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            if (String.IsNullOrEmpty(maKe) || String.IsNullOrEmpty(dungTichKhaDung))
            {
            ...
            string thongBao = a.NapDuLieuVaoTang(maKe, float.Parse(dungTichKhaDung));
        ...
        private void lbMaKe_Click(object sender, EventArgs e)
        {
