...
{
    public partial class ThemKhoChoThue : Form
    {
        public ThemKhoChoThue()
        {
            InitializeComponent();
        }
        ...
        private void tieuDeThemKhoChoThue_MouseDown(object sender, MouseEventArgs e)
        {
            dangKeo = true;
            diemBatDau = new Point(e.X, e.Y);
        }

        private void tieuDeThemKhoChoThue_MouseMove(object sender, MouseEventArgs e)
        {
            if (dangKeo)
            {
        ...
        private void tieuDeThemKhoChoThue_MouseUp(object sender, MouseEventArgs e)
        {
            dangKeo = false;
        }
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            if (String.IsNullOrEmpty(maKho) || String.IsNullOrEmpty(dungTichKhaDung) || String.IsNullOrEmpty(maNhanVien))
            {
            ...
            string thongBao = a.NapDuLieuVaoKhoChoThue( maNhanVien, maKho, float.Parse(dungTichKhaDung), 0);
        ...
        private void ThemKhoChoThue_Load(object sender, EventArgs e)
        {

        }

        private void txtDungTichKhaDung_TextChanged(object sender, EventArgs e)
        {
        ...
        private void lbDungTichKhaDung_Click(object sender, EventArgs e)
        {
